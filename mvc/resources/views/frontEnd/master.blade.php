<!doctype html>
 <html class="no-js" lang=""> 
    ...
    <body>
                        ...
                        <nav class="navbar navbar-default">
                            <div class="container-fluid">
                                ...
                                <div class="navbar-header">
                                    ...
                                    <a class="navbar-brand our_logo" href="#"><img src="{{asset('frontEnd')}}/images/logo.png" alt="" /></a>
                                </div>
                                ...
                                <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                                    ...
                                    <ul class="nav navbar-nav navbar-right">
                                            <li><a href="#slider">Cities</a></li>
                                        <li><a href="#slider">ABOUT US</a></li>
                                        <li><a href="#abouts">BEST FOODS</a></li>
                                        <li><a href="#features">FOODIES</a></li>
                                        <li><a href="#portfolio">SUGGEST CITY</a></li>
                    ...
                    <div class="abouts_content">
                        <div class="col-md-6">
                            <div class="single_abouts_text text-center wow slideInLeft" data-wow-duration="1s">
                                <img src="{{asset('frontEnd')}}/images/ab.png" alt="" />
                            </div>
                        </div>
                        ...
                        <div class="main_mobail_apps_content wow zoomIn">
                            ...
                            <div class="col-md-7 col-sm-12">
                                <div class="single_monail_apps_text">
                                    ...
                                    <a href=""><img src="{{asset('frontEnd')}}/images/google.png" alt="" /></a>
                                    <a href=""><img src="{{asset('frontEnd')}}/images/apps.png" alt="" /></a>
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <script src="{{asset('frontEnd')}}/js/jquery-easing/jquery.easing.1.3.js"></script>
